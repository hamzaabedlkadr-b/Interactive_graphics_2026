...
function createTriangulatedPrototype(parent, position, rotationY = 0) {
...
function createMassSpringCable(parent, position) {
...
function updateMassSpringCable(cable, delta, time) {
  if (delta <= 0) return;
